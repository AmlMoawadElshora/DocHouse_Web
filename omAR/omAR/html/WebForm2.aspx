<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="omAR.html.WebForm2" %>
    ...
    <form id="form1" runat="server">
        <div class="header_section">
         <div class="container-fluid">
               <div class="main">
                  <div class="logo"><a href="WebForm2.aspx"><img src="images/d.png" width="80px" height="40px"></a></div>
                  <div class="menu_text">
                     <ul>
                        <div class="togle_">
                           <div class="menu_main">
                              <ul>
                                 <li><a href="WebForm4.aspx">Book</a></li>
                              </ul>
                           </div>
                        </div>
                        &nbsp &nbsp &nbsp 
      ...
      <div class="protect_section layout_padding">
         <div class="container">
            ...
            <div class="protect_section_2 layout_padding">
               <div class="row">
                  <div class="col-md-6">
                     <h1 class="hands_text"><a href="WebForm4.aspx">See available<br>doctors</a></h1>
                     <h1 class="hands_text_2"><a href="WebForm4.aspx">Choose the<br>prefered doctor</a></h1>
                     <h1 class="hands_text"><a href="WebForm4.aspx">Enter some of the<br>patient data</a></h1>
                  </div>
                  <div class="col-md-6">
               ...
               <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                    <h1 class="news_taital">Our Team</h1>
                     ...
                     <div class="news_section_2 layout_padding">
                        <div class="box_main">
                           <div class="image_1"><img src="WebApplication1/images/as.jpg"></div>
