...
namespace WebApplication1
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        { 
            ...
            SqlCommand yy = new SqlCommand("INSERT INTO [dbo].[join_us] values ('" + fst_name.Text+"','"+lst_name.Text+"','"+email.Text+"','"+phone.Text+"','"+birth.Text+"','"+address.Text+"','"+gender.Text+"','"+edu.Text+"','"+clic.Text+"',@image)",oy);
