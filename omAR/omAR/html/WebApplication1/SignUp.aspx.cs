...
namespace WebApplication1
{
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void signUpp_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cm = new SqlCommand("insert into signUp values('" + uuu.Text + "' , '" + eee.Text + "' ,'" + pp.Text + "' , '" + ppp.Text + "' , '" + sss.Text + "' , '" + answer.Text + "','"+TextBox1.Text+"' )", cn);
                cm.ExecuteNonQuery();
                uuu.Text = sss.Text = eee.Text = ppp.Text = pp.Text = answer.Text=TextBox1.Text = null;
