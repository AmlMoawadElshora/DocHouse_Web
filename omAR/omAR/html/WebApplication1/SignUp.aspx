		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					...
					<asp:TextBox ID="uuu" runat="server" CssClass="text" placeholder="First Name"  ></asp:TextBox> 
				...
				&nbsp &nbsp&nbsp&nbsp
					...
					<br/><br />
					<asp:TextBox ID="TextBox1" runat="server" CssClass="text" placeholder="Last Name"  ></asp:TextBox> 
					<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Required" ControlToValidate="TextBox1" ForeColor="red"></asp:RequiredFieldValidator>
				&nbsp &nbsp&nbsp&nbsp
					<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="please enter letters only" ForeColor="red" ControlToValidate="TextBox1" ValidationExpression="[a-zA-Z ]*$"></asp:RegularExpressionValidator>
